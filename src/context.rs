...
pub struct ServerContext {
    pub entities_by_id: Arc<DashMap<String, Entity>>,
    pub maps_by_id: Arc<DashMap<String, GameWorld>>,
}

impl ServerContext {
    pub fn new() -> Self {
        Self {
            entities_by_id: Arc::new(DashMap::new()),
            maps_by_id: Arc::new(DashMap::new()),
        }
    }
